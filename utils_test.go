...
var strToLocTests = []stringToLocationTest{
	...
	{
		name:    "StrToLoc-2",
		value:   "https://localhost/IDBUS/TESTACC-A",
		scheme:  "https",
		host:    "localhost",
		port:    443,
		context: "IDBUS",
	...
	{
		name:    "StrToLoc-3",
		value:   "https://localhost/IDBUS/TESTACC-A/IDP-1",
		scheme:  "https",
		host:    "localhost",
		port:    443,
		context: "IDBUS",
	...
	{
		name:    "StrToLoc-4",
		value:   "HTTPS://mycompany.com:8443/IDBUS/TESTACC-A/IDP-1",
		scheme:  "https",
		host:    "mycompany.com",
		port:    8443,
		context: "IDBUS",
...
var locToStrTests = []locationToStringTest{
	...
	},
	{
		...
		value: api.LocationDTO{
			...
			Port:     api.PtrInt32(443),
			Context:  api.PtrString("IDBUS"),
			Uri:      api.PtrString("TESTACC-1/IDP-1"),
		},
		url: "https://localhost/IDBUS/TESTACC-1/IDP-1",
	},
	{
		name: "LocToStr-6",
		value: api.LocationDTO{
		...
		url: "https://localhost:8443/IDBUS/TESTACC-1/IDP-1",
	},
}
