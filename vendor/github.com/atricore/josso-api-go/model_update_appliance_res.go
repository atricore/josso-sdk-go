...
// UpdateApplianceRes struct for UpdateApplianceRes
type UpdateApplianceRes struct {
...
type _UpdateApplianceRes UpdateApplianceRes
...
func (o UpdateApplianceRes) MarshalJSON() ([]byte, error) {
...
func (o *UpdateApplianceRes) UnmarshalJSON(bytes []byte) (err error) {
	varUpdateApplianceRes := _UpdateApplianceRes{}

	if err = json.Unmarshal(bytes, &varUpdateApplianceRes); err == nil {
		*o = UpdateApplianceRes(varUpdateApplianceRes)
	}
...
type NullableUpdateApplianceRes struct {
	value *UpdateApplianceRes
	isSet bool
}

func (v NullableUpdateApplianceRes) Get() *UpdateApplianceRes {
	return v.value
}

func (v *NullableUpdateApplianceRes) Set(val *UpdateApplianceRes) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateApplianceRes) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateApplianceRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateApplianceRes(val *UpdateApplianceRes) *NullableUpdateApplianceRes {
	return &NullableUpdateApplianceRes{value: val, isSet: true}
}

func (v NullableUpdateApplianceRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateApplianceRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
